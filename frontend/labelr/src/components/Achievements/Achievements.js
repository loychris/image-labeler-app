...
render() {
    ...
    const achievements = [ 
        ...
        {name: '1 YEAR!' , description: '1 year on plattform',src:pic1, progress: createdAt < hundredDaysago ? 100 : 0},
        {name: '2 YEARS!' , description: '1 month on plattform',src:pic1, progress: createdAt < hundredDaysago ? 100 : 0},
    ]
