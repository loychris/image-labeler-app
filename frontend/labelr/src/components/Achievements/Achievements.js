...
render() {
    ...
    const achievements = [ 
        ...
        {name: 'Elite' , description: '1000 Images labeled in 1 month',src:pic13,progress:counterThisMonth > 999 ? 100 : counterThisWeek/1000*100},
        {name: 'Explorer' , description: '2000 Images labeled in 1 month',src:pic6,progress:counterThisMonth > 1999 ? 100 : counterThisWeek/2000*100},
        {name: 'Hell of a month!' , description: '5000 Images labeled in 1 month',src:pic17,progress:counterThisMonth > 4999 ? 100 : counterThisWeek/5000*100},
        {name: 'Unstoppable Force' , description: '10000 Images labeled in 1 month',src:pic16,progress:counterThisMonth > 9999 ? 100 : counterThisWeek/10000*100},
