...
render() {
    ...
    const achievements = [ 
        ...
        {name: 'Hustler' , description: '500 Images labeled in 1 week',src:pic7,progress:},
        ...
        {name: 'Getting the hang of it' , description: '500 Images labeled in 1 month',src:pic7},
        {name: 'Elite' , description: '1000 Images labeled in 1 month',src:pic7},
        {name: 'Lablr' , description: '2000 Images labeled in 1 month',src:pic7},
        {name: 'Hell of a month!' , description: '5000 Images labeled in 1 month',src:pic7},
